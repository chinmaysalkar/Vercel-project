...
if (vectorMapWorldMarkersColors) {
    var worldemapmarkers = new jsVectorMap({
        ...
        markers: [{
                ...
                style: {
                    image: "<%= process.env.AAP_URL %>assets/images/flags/us.svg",
                }
            },
            {
                name: "Russia",
                ...
                style: {
                    image: "<%= process.env.AAP_URL %>assets/images/flags/russia.svg",
                }
            },
            {
                name: "Spain",
                ...
                style: {
                    image: "<%= process.env.AAP_URL %>assets/images/flags/spain.svg",
                }
            },
            {
                name: "Italy",
                ...
                style: {
                    image: "<%= process.env.AAP_URL %>assets/images/flags/italy.svg",
                }
            },
            {
                name: "Germany",
                ...
                style: {
                    image: "<%= process.env.AAP_URL %>assets/images/flags/germany.svg",
                }
            },
        ],
        markerStyle: {
