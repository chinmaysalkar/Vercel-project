...
var dummyUserImage = "<%= process.env.AAP_URL %>assets/images/users/user-dummy-img.jpg";
var dummyMultiUserImage = "<%= process.env.AAP_URL %>assets/images/users/multi-user.jpg";
...
var emojiPicker = new FgEmojiPicker({
    ...
    position: ["top", "right"],
    preFetch: true,
    dir: "<%= process.env.AAP_URL %>assets/js/pages/plugins/json",
