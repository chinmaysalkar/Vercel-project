...
xhttp.open("GET", "<%= process.env.AAP_URL %>assets/json/table-customer-list.json");
xhttp.send();
    ...
    addBtn.addEventListener("click", function (e) {
        if (
            ...
            customerList.add({
                ...
                category_name: categoryField.value,
